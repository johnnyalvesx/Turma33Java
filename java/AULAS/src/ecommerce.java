...
public class ecommerce {
	...
	final int VALORFIXO = 11;
	String nomeLoja = "NANPPA " , slogan = "A Loja do dev desesperado\n" ;
	String produto[VALORFIXO];
	String codigo[VALORFIXO];
	String estoque[VALORFIXO];
	String valor[VALORFIXO];
	String tituloMatriz[4];
	String quantidadeCarrinho[VALORFIXO];
	double valorCompra[VALORFIXO];
	double valorTotalDaCompra = 0.00;
	double precoPagar = 0.00;
	char opcao=' ';
